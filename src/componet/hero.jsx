...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-[var(--background)] pt-20">
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        {/* Value statement */}
        <p className="max-w-2xl mx-auto text-base md:text-lg leading-relaxed mb-10 text-[var(--foreground)] animate-slide-up is-visible">
          I build clear, maintainable web applications with a focus on usability, performance, and long-term reliability.
        </p>

        {/* CTAs */}
        <div className="flex gap-4 justify-center items-center animate-fade-in is-visible">
          <button
        ...
        {/* Scroll indicator */}
        <div className="mt-16 animate-fade-in is-visible">
